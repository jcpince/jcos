	   ...
	   struct fde_vector *linear, struct fde_vector *erratic)
{
  ...
  for (i = 0; i < count; i++)
	   ...
	   probe = chain_end)
	{
	  ...
	  erratic->array[probe - linear->array] = (const fde*)NULL;
	}
...
init_object (struct object* ob)
{
  ...
  if (count == 0)
      ...
      else
	{
	  ...
	  if (count == (size_t) -1)
	    {
	      static const fde terminator = {0,0,{}};
	    unhandled_fdes:
	      ob->s.i = 0;
	      ob->s.b.encoding = DW_EH_PE_omit;
  ...
  for (lo = 0, hi = vec->count; lo < hi; )
    {
      ...
      if (pc < pc_begin)
	hi = i;
      else if (pc >= (void*)((addr_t)pc_begin + pc_range))
	lo = i + 1;
      else
	return f;
    }
