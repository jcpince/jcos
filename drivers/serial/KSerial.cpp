...
static constexpr uint32_t uart_ports[4] = { 0x3f8, 0x2f8, 0x3e8, 0x2e8 };

KSerial::KSerial(uint32_t portid)
{
    this->portid = portid;
    outportb(uart_ports[portid] + 1, 0x00);    // Disable all interrupts
