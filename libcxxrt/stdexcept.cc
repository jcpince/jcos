...
bad_alloc::~bad_alloc() {}
bad_alloc::bad_alloc(const bad_alloc &a) throw() : exception(a) {}
...
bad_cast::~bad_cast() {}
bad_cast::bad_cast(const bad_cast &c) throw() : exception(c) {}
...
bad_typeid::bad_typeid(const bad_typeid &__rhs) throw() : exception(__rhs) {}
